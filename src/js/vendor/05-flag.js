const shader = {
	...
	float noiseRatio = 1.0;
	
	// apply simplex noise based on time
	vec3 simplexNoise = vec3(snoise((screenUV * noiseRatio) - (uTime / 150.0)));
	...
	// finalColor = vec4(30, 30, 30, 0.1);
	
	// // fake shadows based on vertex position along Z axis
	// finalColor.rgb -= clamp(-vVertexPosition.z / 5.0, 4.0, 1.0);
...
window.onload = function () {
	...
	var webGLCurtain2 = new Curtains("canvas");
